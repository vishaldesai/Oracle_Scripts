...
--                - takse 60 stack samples of process tied to sid 148 with 1
--                  second interval
--	        
...
--                         event crashed target processes on Windows platforms
--
--                         Use an OS stack sampler instead when need to diagnose
--                         production issues (and test event those well in dev)
--
-- 
...
--              doesn't seem to support it thoug, but you have DTrace there anyway ;)
--
-------------------------------------------------------------------------------------

PROMPT
PROMPT -- oStackProf v1.00 - EXPERIMENTAL script by Tanel Poder ( http://www.tanelpoder.com )
PROMPT
...
HOST "cscript //nologo C:\Users\U267399\Desktop\Tools\scripts\stack_helper.vbs -strip < ostackprof_&ostackprof_spid..txt | sort | cscript //nologo C:\Users\U267399\Desktop\Tools\scripts\stack_helper.vbs -report | sort /r"
