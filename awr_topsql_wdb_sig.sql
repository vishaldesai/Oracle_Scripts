...
SELECT
 case when '&&sql_order' = 'elapsed' then 'sql_order_elapsed_sig.sql'
      when '&&sql_order' = 'cpu'	 then 'sql_order_cpu_sig.sql'
	  when '&&sql_order' = 'gets'	 then 'sql_order_gets_sig.sql'
	  when '&&sql_order' = 'reads'   then 'sql_order_reads_sig.sql'
	  when '&&sql_order' = 'cluster' then 'sql_order_cluster_sig.sql'
	  when '&&sql_order' = 'execs'   then 'sql_order_execs_sig.sql'
	  when '&&sql_order' = 'iowait'   then 'sql_order_iowait_sig.sql'
 END AS SELECTED
FROM dual;
